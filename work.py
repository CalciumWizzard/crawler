...
def selection():
  with open("settings.ini") as f:
    ...
    pt.align= 'l'
    print >>table_file, pt
    tkMessageBox.showinfo( "Hello Python", pt )
...
newscale = Scale(root, variable = newvar)
button = Button(root, text="Get ALL Values", command=selection)


L1 = Label(root, text="Your Word")
